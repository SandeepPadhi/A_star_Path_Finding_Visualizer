...
#PRESS C TO CLEAR THE SCREEN AT POINT OF TIME
...
def draw_text(Win,rows,width):
    ...
    text = font.render("Sandeep Padhi",True,WHITE,BLACK)
    textRect=text.get_rect()
    textRect.center=(rows//2+83-gap*2,rows//2)
    Win.blit(text, textRect)

    font = pygame.font.Font('freesansbold.ttf',18 )
    text = font.render("IIIT LUCKNOW",True,WHITE,BLACK)
    textRect=text.get_rect()
    textRect.center=(rows//2+74-gap*2,rows//2+18)
    Win.blit(text, textRect)
    
    font = pygame.font.Font('freesansbold.ttf',20 )
    text = font.render("Project: A* Path Finding Visualizer",True,WHITE,BLACK)
    textRect=text.get_rect()
    textRect.center=(rows//2+210-gap*4,rows//2+38)
    Win.blit(text, textRect)
